...
class GCN(torch.nn.Module):
    ...
    def _build(self):
        ...
        self.conv1 = GCNConv(input_dim, self.conv_dim[0], cached=False)
        # self.conv2 = GCNConv(self.conv_dim[0], self.conv_dim[1], cached=False)
...
def build_train_data(mat, config):
    ...
    """
    users, items, label = sample_dataset(mat, neg_ratio=5)
