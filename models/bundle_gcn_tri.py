...
Data = namedtuple('Data', ['x', 'edge_index_ub', 'edge_index_ui', 'edge_index_bi'])
...
class GCNTri(torch.nn.Module):
    def __init__(self, config=None):
        ...
        self.ub_conv1 = GCNConv(input_dim, self.conv_dim[0], cached=True)
        self.ui_conv1 = GCNConv(input_dim, self.conv_dim[0], cached=True)
        self.bi_conv1 = GCNConv(input_dim, self.conv_dim[0], cached=True)
        self.ub_conv2 = GCNConv(self.conv_dim[0], self.conv_dim[1], cached=True)
        self.ui_conv2 = GCNConv(self.conv_dim[0], self.conv_dim[1], cached=True)
        self.bi_conv2 = GCNConv(self.conv_dim[0], self.conv_dim[1], cached=True)
